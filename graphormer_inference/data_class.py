...
#         self.raw_dir = '/home/jovyan/'
    ...
    def raw_dir(self) -> str:
        return GLOBAL_ROOT + '/datasets/omsk/raw'
    ...
    def process(self):
        ...
        data = pd.read_csv(osp.join(GLOBAL_ROOT + '/datasets/omsk/raw', 'omsk_full_routes_final_weather_L_NaN_filtered_FIXED.csv'))
...
class single_geo_Abakan_last(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None, split = 'train'):
        super(single_geo_Abakan, self).__init__(root, transform, pre_transform)
        self.data, self.slices = torch.load(self.processed_dir + '/predict_data.pt')
